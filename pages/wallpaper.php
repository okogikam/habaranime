<?php
$galleryWP = $data->dataQuery($conn,"SELECT * FROM wallpaper ORDER BY no DESC");
//$url = "?page=Gallery";
?>
...
<!--
        <div class="p-3  pb-0">
            <div class="m-gallery">
            <div class="demo-gallery row m-auto">
-->
        <div class="masonry">
  
            <?php
            // print_r($galleryWP);
            foreach($galleryWP as $gambar)
                echo<<<_END
            <div class="item">    
            <a class="">
            <img class="img img-gallery" src="$gambar[url]" alt="$gambar[alt]" title="$gambar[tag]">
            </a>
            </div>
_END;
                ?>
